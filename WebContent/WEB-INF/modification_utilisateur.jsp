...
<meta charset="UTF-8">
<title>ENI-Enchéres - Modification de compte</title>
<script> 
function validate()
{ 
...
<div align ="center">
		...
		<br>
		<br>
	<form name="form" action="${pageContext.request.contextPath }/updateUser" method="post" onsubmit="return validate()">
...
<br>
	<form name="form" action="${pageContext.request.contextPath }/deleteUser" method="post">
